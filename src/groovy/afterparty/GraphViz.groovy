...
class GraphViz {
    ...
    public void increaseDpi() {
        if (this.currentDpiPos < (this.dpiSizes.length - 1)) {
            this.currentDpiPos = this.currentDpiPos + 1;
        }
    }
    ...
    private byte[] get_img_stream(File dot, String type) {
        ...
        try {
            ...
            FileInputStream inStream = new FileInputStream(img.getAbsolutePath());
            img_stream = new byte[inStream.available()];
            inStream.read(img_stream);
